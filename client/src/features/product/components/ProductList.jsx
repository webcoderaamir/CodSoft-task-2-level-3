                ...
                <div className="lg:col-span-3">
                  ...
                  <div className="bg-white border">
                    <div className="mx-auto max-w-2xl px-4 py-1 sm:px-6 sm:py-1 lg:max-w-7xl lg:px-8">
                      <h2 className="text-xl mt-2 font-bold tracking-tight text-gray-900">
                        Products
                      </h2>

                      <div className="mt-3 grid grid-cols-1 gap-x-6 gap-y-7 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
                        {products.map((product) => (
                          ...
                          >
                            <div
                              key={product.id}
                              className="group relative border-solid rounded border-2 p-2"
                            >
